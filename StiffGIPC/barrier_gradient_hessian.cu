...
//=============================================================================
#define USE_CUBIC_BARRIER false  // Change to true to use cubic barrier
    ...
    if(MMCVIDI.x >= 0)
    {
        ...
        else
        {
            ...
            _d_EE(_vertexes[MMCVIDI.x],
                  ...
                  _vertexes[MMCVIDI.w],
                  dis);
            double I2 = dis / dHat; // Note: dis is squared distance here from _d_EE? No, _d_EE usually returns squared distance. 
                                    // But wait, line 128 I2 = dis/dHat. dHat is squared threshold.
                                    // If dis is squared distance, I2 = (d/dHat)^2 = I5.
                                    // But later dis = sqrt(dis).
            ...
            double F22 = F.m[2][2]; // F22 should be passed if needed, or calculated inside if standard.
            // Wait, F22 in parallel_hessian_coeffs is used? 
            // The definition: double I1, double I2, double c, double F22, ...
            // F22 is passed as argument.
            // In the original code: lambdag1g uses F.m[2][2].
